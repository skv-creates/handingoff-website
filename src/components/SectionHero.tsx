...
export function SectionHero() {
  return (
    <section className="hero-texture relative flex min-h-[800px] w-full flex-col items-center justify-center overflow-hidden px-[var(--space-lg)]">
      <div className="relative flex w-full max-w-[800px] flex-col items-start gap-[48px]">
        ...
        <a
          href="#download"
          className="flex items-center gap-[16px] rounded-[var(--radius-2xl)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-secondary)] py-[var(--space-sm)] pl-[var(--space-lg)] pr-[var(--space-md)] transition-colors hover:bg-[var(--color-surface)]"
